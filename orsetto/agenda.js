  ...
  if (appointmentsFromLocalStorage) {
    ...
    appointments.forEach((app, i) => {
      ...
      deleteButton.addEventListener('click', function (e) {
        ...
        // aggiungo un index da associare ad ogni button creato per collegarlo allo splice
        appointments.splice(i,1)

        // aggiorno il local storage con le modifiche
        localStorage.setItem(
            'appointments',
            JSON.stringify(appointments)
        )

        // rigenero nuovamente la lista a schermo
        generateList()
